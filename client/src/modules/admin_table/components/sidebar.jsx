...
const menuItems = [
  { text: "Student List", bgColor: "bg-blue-300", to: { pathname: ENDPOINTS.ADMIN.STUDENTLIST } },
  { text: "Teacher List", bgColor: "bg-red-400", to: { pathname: ENDPOINTS.USER.EDIT_INFO} },
